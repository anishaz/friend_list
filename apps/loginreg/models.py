...
class UserManager(models.Manager):
    ...
    def registration(self, data):
        ...
        if not EMAIL_REGEX.match(data['email']):
            errors.append("Invalid Email Address. Please try again.")
        ...
        user = User.objects.create(first_name = data['first_name'], last_name = data['last_name'], alias = data['alias'], email = data['email'], password = data['password'])
        return {'user' : user}
